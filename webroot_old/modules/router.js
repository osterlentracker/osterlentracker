...
export default new Router({
	routes: [
		...
		{url: '_=_', params: {page: 'home'}},
		{url: 'forums', params: {page: 'forums'}},
		{url: 'forums/{forumId}', params: {page: 'forum'}},
		{url: 'forums/{forumId}/thread/{threadId}', params: {page: 'forum-thread'}},
		{url: 'about', params: {page: 'about'}},
		{url: 'about/press', params: {page: 'press'}},
		{url: 'about/contact', params: {page: 'contact'}},
		{url: 'settings', params: {page: 'settings'}},
		{url: 'administration', params: {page: 'administration'}},
		{url: 'chat', params: {page: 'chatPage'}},
		{url: 'about/donate', params: {page: 'donate'}}
	]
});